// https://github.com/alii/search/blob/master/src/links.ts#L3
export const etherscanTypeMap = {
	a: 'address',
};

export const SITES: Record<string, string | ((query: string) => string) | undefined> = {
	// Default
	help: 'https://github.com/carterhimmel/searchy/issues',
	...
	eth: (args) => {
		...
		return `https://etherscan.io/${
			type in etherscanTypeMap ? etherscanTypeMap[type as keyof typeof etherscanTypeMap] : type
		}/${q}`;
	},
